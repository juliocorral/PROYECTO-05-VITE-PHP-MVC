        ...
        <section>
            ...
            <article class="artForm">
                ...
                <form action="<?=base_path()?>/app/gestionForm" method="post">
                    ...
                    <span class="error"><?php if(isset($campo) && $campo == "nombre"){echo sprintf($data['error_field_type'], $campo, $error);} ?></span>
                    ...
                    <input type="text" class='<?php if(isset($campo) && $campo == "nombre"){ echo "inputError";} ?>' name="nombre" id="nombre" placeholder="<?= $data['placeholder_nombre'] ?>" value="<?php if(isset($nombre)){echo $nombre;}?>">

                    <span class="error"><?php if( isset($campo) && $campo == "telefono"){echo sprintf($data['error_field_type'], $campo, $error);} ?></span>
                    <label for="tel"><?= $data['label_tel'] ?></label>
                    <input type="tel" class='<?php if(isset($campo) && $campo == "telefono"){ echo "inputError";} ?>' name="tel" id="tel" placeholder="<?= $data['placeholder_tel'] ?>" value="<?php if(isset($tel)){echo $tel;}?>">

                    
                    <span class="error"><?php if( isset($campo) && $campo == "email"){echo sprintf($data['error_field_type'], $campo, $error);} ?></span>
                    <label for="email"><?= $data['label_email'] ?></label>
                    <input type="email" class='<?php if(isset($campo) && $campo == "email"){ echo "inputError";} ?>' name="email" id="email" placeholder="<?= $data['placeholder_email'] ?>" value="<?php if(isset($email)){echo $email;}?>">


                    <span class="error"><?php if( isset($campo) && $campo == "mensaje"){echo sprintf($data['error_field_type'], $campo, $error);} ?></span>
                    <label for="mensaje"><?= $data['label_mensaje'] ?></label>
                    <textarea name="mensaje" class='<?php if(isset($campo) && $campo == "mensaje"){ echo "inputError";} ?>' id="mensaje" placeholder="<?= $data['placeholder_mensaje'] ?>"><?php if(isset($mensaje)){echo $mensaje;}?></textarea>
                    ...
                    <!-- CAPTCHA -->
                    <span class="error"><?php if(isset($campo) && $campo == "captcha"){echo $data['error_captcha'];} ?></span>
                    <div>
                        <label for="respUser"><?= $data['captcha_label'] ?></label>
